...
INSERT INTO `customer` (CUS_ID,CUS_NAME,CUS_PHN_NO,CUS_USERNAME,CUS_PASSWORD,CUS_EMAIL) VALUES (1,'Prasanna Pappu','9381413089','prassucp','hexaware@','prassucp@gmail.com'),
...
INSERT INTO `customer` (CUS_ID,CUS_NAME,CUS_PHN_NO,CUS_USERNAME,CUS_PASSWORD,CUS_EMAIL) VALUES (4,'Rithesh Rai','7025590419','rithesh','rithesh','rithesh@gmail.com');
...
INSERT INTO `menu` VALUES (1,'CHICKEN BIRIYANI',856.00,750,'NON-VEG'),
(2,'CHICKEN 65',674.00,500,'NON-VEG'),
(3,'GOBI MANCHURIAN',684.00,650,'VEG'),
(4,'CHICKEN MANCHURIAN',999.00,750,'NON-VEG'),
(5,'FISH',901.00,850,'NON-VEG'),
(6,'DAHI BHALLE',111.00,150,'VEG'),
(7,'MIX PRANTHA',911.00,360,'VEG'),
(8,'GOL GAPPE',901.00,170,'VEG'),
(9,'PRAWN BIRYANI',901.00,580,'NON-VEG'),
(10,'THAI NOODLES',744.00,660,'VEG');
...
INSERT INTO `orders` VALUES (1,1,1,'PAYTM',1,NULL,1,856,'ACCEPTED','slkjf'),
(12,1,2,'PAYTM',1,NULL,1,856,'DENIED','salfkasf'),
(13,2,1,'PAYTM',1,NULL,1,856,'PENDING','aslkfdjasdf'),
(14,1,1,'PAYTM',1,NULL,1,856,'PENDING','asfasf'),
(15,2,2,'PAYTM',1,NULL,1,856,'PENDING','asfasf'),
(16,1,1,'PAYTM',1,NULL,1,856,'PENDING','lkasfd'),
(17,2,1,'PAYTM',1,NULL,1,856,'PENDING','lkasfd'),
(18,1,1,'PAYTM',1,NULL,1,856,'PENDING','Make it Faster'),
(19,2,2,'PAYTM',6,NULL,1,111,'PENDING','aklsdfkljasf'),
(20,1,2,'PAYTM',2,NULL,1,674,'PENDING','make it faster'),
(21,1,1,'PAYTM',1,NULL,2,1712,'PENDING','Make is Spicy...Prasanna'),
(22,1,1,'PAYTM',1,'2021-11-08',2,1712,'DENIED','Make is Spicy...Prasanna'),
(23,1,1,'PAYTM',1,'2021-11-08',12,10272,'PENDING','Make is Spicy...Prasanna'),
(24,1,1,'PAYTM',1,'2021-11-08',1,856,'ACCEPTED','New Order');
...
INSERT INTO `vendor` VALUES (1,'Balan','8554535400','balan89','chennai@123','balan@gmail.com'),
(2,'Anukriti','9184532455','anu56','bordia@123','anu.delhi@gmail.com'),
(3,'Aarifa','9115879011','aarifk','saleem@123','aarifkhan@gmail.com'),
(4,'Ksheerabdi','9874499011','ksheera','kolkata@123','ramki9@gmail.com'),
(5,'Sai Kumar','88234555','saikumarm','infinite','sai@gmail.com'),
(55,'Swiggy','84823855','swizzy999','AlwaysDeliver','swizzy99@gmail.com');

INSERT INTO `vendor` VALUES (6,'saathvik','8554535400','saath','saath','saath.com');
...
(3,8,56.36,'PAYTM'),
(3,9,4566,'DEBIT_CARD');
INSERT INTO `wallet` VALUES (4,10,5000,'PAYTM');